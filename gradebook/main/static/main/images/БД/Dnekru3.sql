...
create table schedule (
    ...
    FOREIGN KEY (class_num) references classes(numberClass) on delete cascade,
    FOREIGN KEY (class_tit) references classes(titleClass) on delete cascade,
    dateLesson datetime
); 
-- drop table roles;
-- create table roles (
